#ExternalChecksum("..\..\..\Activity.xaml","{406ea660-64cf-4c82-b6f0-42d48172a799}","85118CEE304413E2BD510426DF463B91")
'------------------------------------------------------------------------------
' <auto-generated>
...
Partial Public Class ActivityForm
    ...
    Friend WithEvents ListView3 As System.Windows.Controls.ListView
    ...
    Friend WithEvents ListView4 As System.Windows.Controls.ListView
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",65)
    Friend WithEvents Grid5 As System.Windows.Controls.Grid
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",66)
    Friend WithEvents ListView5 As System.Windows.Controls.ListView
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",78)
    Friend WithEvents Grid6 As System.Windows.Controls.Grid
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",79)
    Friend WithEvents ListView6 As System.Windows.Controls.ListView
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",91)
    Friend WithEvents Grid7 As System.Windows.Controls.Grid
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",92)
    Friend WithEvents ListView7 As System.Windows.Controls.ListView
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",106)
    Friend WithEvents GroupBox2 As System.Windows.Controls.GroupBox
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",108)
    Friend WithEvents chkNoncompliance As System.Windows.Controls.CheckBox
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",109)
    Friend WithEvents chkWeakness As System.Windows.Controls.CheckBox
    
    #End ExternalSource
    
    
    #ExternalSource("..\..\..\Activity.xaml",110)
    ...
    #ExternalSource("..\..\..\Activity.xaml",112)
    ...
    Sub System_Windows_Markup_IComponentConnector_Connect(ByVal connectionId As Integer, ByVal target As Object) Implements System.Windows.Markup.IComponentConnector.Connect
        ...
        If (connectionId = 20) Then
            Me.ListView3 = CType(target,System.Windows.Controls.ListView)
            Return
        End If
        ...
        If (connectionId = 22) Then
            Me.ListView4 = CType(target,System.Windows.Controls.ListView)
            Return
        End If
        ...
        If (connectionId = 24) Then
            Me.ListView5 = CType(target,System.Windows.Controls.ListView)
            Return
        End If
        ...
        If (connectionId = 26) Then
            Me.ListView6 = CType(target,System.Windows.Controls.ListView)
            Return
        End If
        ...
        If (connectionId = 28) Then
            Me.ListView7 = CType(target,System.Windows.Controls.ListView)
            Return
        End If
